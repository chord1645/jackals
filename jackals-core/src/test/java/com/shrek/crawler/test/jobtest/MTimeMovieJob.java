...
public class MTimeMovieJob extends BaseTest {
...
//                ImmutableList.of("10","20","30"),
    ...
    public static JobInfo job() {
        JobInfo jobInfo = JobInfo.create("movie.mtime.com");
        jobInfo.setMaxDepth(1);
        jobInfo.setJobThreadNum(5);
        jobInfo.setSleep(200L);
        jobInfo.setReset(true);
        jobInfo.getSeed().add("http://theater.mtime.com/China_Beijing/");
        Orders orders = new Orders();
        orders.setPathRegx("http://movie.mtime.com/[0-9]+/");
        orders.setTargetRegx("^http://movie.mtime.com/[0-9]+/$");
